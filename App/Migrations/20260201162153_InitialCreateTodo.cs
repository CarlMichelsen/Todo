...
namespace App.Migrations
{
    ...
    public partial class InitialCreateTodo : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_selected_at = table.Column<DateTime>(
                        type: "timestamp with time zone",
                        nullable: true
                    ),
                    created_at = table.Column<DateTime>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    product_id = table.Column<string>(
                        type: "character varying(100)",
                        maxLength: 100,
                        nullable: true
                    ),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    table.PrimaryKey(
                        "pk_calendar_entity_calendar_link_entity",
                        x => new { x.calendar_links_id, x.calendars_id }
                    );
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "calendar_link", schema: "todo");

            migrationBuilder.DropTable(name: "user", schema: "todo");

            migrationBuilder.DropTable(name: "calendar", schema: "todo");
        }
    }
}
