...
{
    public static UserDto ToDto(this JwtUser jwtUser) =>
        new(UserId: jwtUser.UserId, UserName: jwtUser.Username, Profile: jwtUser.Profile);
    ...
    public static PersonalUserDto ToPersonalUserDto(this UserEntity userEntity, JwtUser jwtUser) =>
        new(
            UserId: userEntity.Id,
