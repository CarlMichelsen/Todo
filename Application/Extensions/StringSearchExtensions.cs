...
#pragma warning restore CA1862
        ...
        where T : class, IEntity
    {
        ...
        if (entityType == null)
        {
            throw new InvalidOperationException(
                $"Entity type {typeof(T).Name} not found in the model."
            );
        }
        ...
        return property is null
            ? throw new InvalidOperationException(
                $"Property {propertyName} not found on entity {typeof(T).Name}."
            )
        ...
        where T : class, IEntity
    {
        ...
        return entityType.GetProperties().ToDictionary(p => p.Name, p => p.GetColumnName());
    }
